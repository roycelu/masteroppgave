...
class MainDrone:
    ...
    def calculate_positions_toward_next_point(self, poly_array, list_of_sheep, canvas):
        ...
        back_vector = (point_of_intersection[0]-mass_center[0], point_of_intersection[1]-mass_center[1])
        ...
        point_left1 = (mass_center[0]+vector_left1[0], mass_center[1]+vector_left1[1])
        ...
        point_right1 = (mass_center[0]+vector_right1[0], mass_center[1]+vector_right1[1])

        # Points at pi/3 degree away from point a
        vector_left2 = (back_vector[0]*np.cos(np.pi/3)-back_vector[1]*np.sin(np.pi/3), back_vector[0]*np.sin(np.pi/3)+back_vector[1]*np.cos(np.pi/3))
        point_left2 = (mass_center[0]+vector_left2[0], mass_center[1]+vector_left2[1])
        vector_right2 = (back_vector[0]*np.cos(-np.pi/3)-back_vector[1]*np.sin(-np.pi/3), back_vector[0]*np.sin(-np.pi/3)+back_vector[1]*np.cos(-np.pi/3))
        point_right2 = (mass_center[0]+vector_right2[0], mass_center[1]+vector_right2[1])
        ...
        return point_left2, point_of_intersection, point_right2, point_left1, point_right1
